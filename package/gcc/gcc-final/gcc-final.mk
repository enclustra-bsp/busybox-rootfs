...
# In gcc 4.7.x and 4.8.x, the ARM EABIhf library loader path for (e)glibc
# was not correct, so we create a symbolic link to make things work
# properly. eglibc installs the library loader as ld-linux-armhf.so.3,
# but gcc creates binaries that reference ld-linux.so.3.
ifeq ($(BR2_arm)$(BR2_ARM_EABIHF)$(filter y,$(BR2_GCC_VERSION_4_8_X) $(BR2_GCC_VERSION_4_7_X))$(BR2_TOOLCHAIN_USES_GLIBC),yyyy)
